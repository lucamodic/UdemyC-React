...
namespace AccesosDatos.Context;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=proyecto;Trusted_Connection=True;Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FA1CCF264");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FD6A716C1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FD9793BA2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F4DD3A905");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7D4882C64");
